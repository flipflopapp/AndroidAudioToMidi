...
#define debug(...)              if(verbose) LOGV (__VA_ARGS__)
#define errmsg(...)             LOGE (__VA_ARGS__)
#define outmsg(...)             LOGV (__VA_ARGS__)
 ...
 *
 */
// TODO: TK Move logging somewhere centralized
...
#define AUBIO_ERR(format, args...)   LOGE(format , ##args)
#define AUBIO_MSG(format, args...)   LOGV(format , ##args)
#define AUBIO_DBG(format, args...)   if(verbose) LOGD(format , ##args)
#else
